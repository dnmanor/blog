...
{% galleryImage "content/img/photos/boat.JPG", "boat" %}
{% galleryImage "content/img/photos/IMG_8967.JPG", "IMG_8967" %}
{% galleryImage "content/img/photos/t.JPG", "t" %}
{% galleryImage "content/img/photos/cas_two.JPG", "cas_two" %}
{% galleryImage "content/img/photos/IMG_9368.JPG", "IMG_9368" %}
{% galleryImage "content/img/photos/IMG_1162.JPG", "IMG_1162" %}
{% galleryImage "content/img/photos/IMG_9707.JPG", "IMG_9707" %}
{% galleryImage "content/img/photos/flowers_one.JPG", "flowers_one" %}
{% galleryImage "content/img/photos/IMG_9145.JPG", "IMG_9145" %}
{% galleryImage "content/img/photos/IMG_1045.JPG", "IMG_1045" %}
{% galleryImage "content/img/photos/biker.JPG", "Biker i saw around Lagawe, Ifugao, Philippines" %}
{% galleryImage "content/img/photos/cas_one.JPG", "cas_one" %}
{% galleryImage "content/img/photos/cas_four.JPG", "cas_four" %}
{% galleryImage "content/img/photos/IMG_8319.JPG", "IMG_8319" %}
{% galleryImage "content/img/photos/IMG_9102.JPG", "IMG_9102" %}
{% galleryImage "content/img/photos/IMG_1231.JPG", "IMG_1231" %}
{% galleryImage "content/img/photos/IMG_9119.JPG", "IMG_9119" %}
{% galleryImage "content/img/photos/IMG_4156.JPG", "IMG_4156" %}
{% galleryImage "content/img/photos/IMG_8970.JPG", "IMG_8970" %}
{% galleryImage "content/img/photos/IMG_9032.JPG", "IMG_9032" %}
{% galleryImage "content/img/photos/IMG_9036.JPG", "IMG_9036" %}
{% galleryImage "content/img/photos/idols.JPG", "idols" %}
{% galleryImage "content/img/photos/IMG_8987.JPG", "IMG_8987" %}
{% galleryImage "content/img/photos/IMG_9120.JPG", "IMG_9120" %}
{% galleryImage "content/img/photos/landscapeone.JPG", "landscapeone" %}
{% galleryImage "content/img/photos/IMG_1109.JPG", "IMG_1109" %}
{% galleryImage "content/img/photos/cas_three.JPG", "cas_three" %}
{% galleryImage "content/img/photos/IMG_1078.JPG", "IMG_1078" %}
{% galleryImage "content/img/photos/IMG_9705.JPG", "IMG_9705" %}
{% galleryImage "content/img/photos/chinatown_two.JPG", "chinatown_two" %}
{% galleryImage "content/img/photos/rm_one.JPG", "rm_one" %}
{% galleryImage "content/img/photos/building_one.JPG", "building_one" %}
{% galleryImage "content/img/photos/IMG_1288.JPG", "IMG_1288" %}
{% galleryImage "content/img/photos/IMG_1092.JPG", "IMG_1092" %}
{% galleryImage "content/img/photos/fwd.JPG", "fwd" %}
{% galleryImage "content/img/photos/river.JPG", "Took this on a bus tour in Singapore" %}
{% galleryImage "content/img/photos/IMG_1076.JPG", "IMG_1076" %}
{% galleryImage "content/img/photos/building_two.JPG", "building_two" %}
{% galleryImage "content/img/photos/IMG_1190.JPG", "IMG_1190" %}
{% galleryImage "content/img/photos/IMG_8535.JPG", "IMG_8535" %}
{% galleryImage "content/img/photos/chinatown_3.JPG", "chinatown_3" %}
{% galleryImage "content/img/photos/pigeon.JPG", "A pigeon" %}
{% galleryImage "content/img/photos/IMG_0507.JPG", "IMG_0507" %}
{% galleryImage "content/img/photos/IMG_9404.JPG", "IMG_9404" %}
{% galleryImage "content/img/photos/IMG_4784.JPG", "IMG_4784" %}
...
{% galleryImage "content/img/photos/art5.jpg", "art5" %}
{% galleryImage "content/img/photos/bags.JPG", "bags" %}
{% galleryImage "content/img/photos/diani.JPG", "diani" %}
{% galleryImage "content/img/photos/drink.JPG", "drink" %}
{% galleryImage "content/img/photos/flower.jpg", "flower" %}
{% galleryImage "content/img/photos/glassart.JPG", "glassart" %}
{% galleryImage "content/img/photos/lexie.jpg", "lexie" %}
{% galleryImage "content/img/photos/lexie_as_a_pup.JPG", "lexie_as_a_pup" %}
{% galleryImage "content/img/photos/meXcas.jpg", "meXcas" %}
{% galleryImage "content/img/photos/peacock.jpg", "peacock" %}
{% galleryImage "content/img/photos/plant_shop.JPG", "plant_shop" %}
{% galleryImage "content/img/photos/restaurant.JPG", "restaurant" %}
{% galleryImage "content/img/photos/street5.JPG", "street5" %}
{% galleryImage "content/img/photos/sushi.jpg", "sushi" %}
{% galleryImage "content/img/photos/tennis_court.JPG", "tennis_court" %}
{% galleryImage "content/img/photos/tents.JPG", "tents" %}
{% galleryImage "content/img/photos/u1.JPG", "u1" %}
